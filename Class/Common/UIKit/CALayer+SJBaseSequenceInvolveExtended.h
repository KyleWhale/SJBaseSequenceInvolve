//
//  CALayer+SJBaseSequenceInvolveExtended.h
...
typedef void(^SJAnimationDidStopHandler)(__kindof CAAnimation *anim, BOOL finished);

@interface CALayer (SJBaseSequenceInvolveExtended)

//
//  UIScrollView+SJBaseSequenceInvolveExtended.m
...
@implementation UIScrollView (SJBaseSequenceInvolveExtended)
...
- (BOOL)tchViewAppearedWithTag:(NSInteger)tag insets:(UIEdgeInsets)insets atIndexPath:(NSIndexPath *)indexPath {
...
- (BOOL)tchViewAppearedWithProtocol:(Protocol *)protocol tag:(NSInteger)tag insets:(UIEdgeInsets)insets atIndexPath:(NSIndexPath *)indexPath {

...
- (BOOL)allowsRotation {
    ...
    if ( _redundantSemicolon && !_transitioning ) return YES;
...
- (BOOL)prefersStatusBarHiddenForRotationFullscreenViewController:(SJRotationFullscreenViewController *)viewController {
    return _redundantSemicolon ? SJRotationIsFullscreenOrientation(_deviceOrientation) : [_actionForwarder prefersStatusBarHidden];
}

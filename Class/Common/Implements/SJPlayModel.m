...
- (BOOL)pridFindInScrollView { return NO; }
...
- (nullable UIView *)playerSuperview {
    ...
    return [_scrollView viewWithProtocol:@protocol(SJEnvironSuperHoldModelView) tag:self.superviewTag];
}
...
- (nullable UIView *)playerSuperview {
    ...
    return [_tableView viewWithProtocol:@protocol(SJEnvironSuperHoldModelView) tag:self.superviewTag atIndexPath:_indexPath];
}
- (nullable __kindof UIScrollView *)inScrollView {
    return _tableView;
}
...
- (nullable UIView *)playerSuperview {
    ...
    return [_tableHeaderView viewWithProtocol:@protocol(SJEnvironSuperHoldModelView) tag:self.superviewTag];
}
- (nullable __kindof UIScrollView *)inScrollView {
    return _tableView;
}
...
- (nullable UIView *)playerSuperview {
    ...
    return [_tableFooterView viewWithProtocol:@protocol(SJEnvironSuperHoldModelView) tag:self.superviewTag];
}
- (nullable __kindof UIScrollView *)inScrollView {
    return _tableView;
}
...
- (nullable UIView *)playerSuperview {
    ...
    return [_tableView viewWithProtocol:@protocol(SJEnvironSuperHoldModelView) tag:self.superviewTag inHeaderForSection:_section];
}
- (nullable __kindof UIScrollView *)inScrollView {
    return _tableView;
}
...
- (nullable UIView *)playerSuperview {
    ...
    return [_tableView viewWithProtocol:@protocol(SJEnvironSuperHoldModelView) tag:self.superviewTag inFooterForSection:_section];
}
- (nullable __kindof UIScrollView *)inScrollView {
    return _tableView;
}
...
- (nullable UIView *)playerSuperview {
    ...
    return [[self inScrollView] viewWithProtocol:@protocol(SJEnvironSuperHoldModelView) tag:self.superviewTag atIndexPath:_indexPath];;
}
...
- (nullable UIView *)playerSuperview {
    ...
    return [[self inScrollView] viewWithProtocol:@protocol(SJEnvironSuperHoldModelView) tag:self.superviewTag inHeaderForSection:_section];;
}
...
- (nullable UIView *)playerSuperview {
    ...
    return [[self inScrollView] viewWithProtocol:@protocol(SJEnvironSuperHoldModelView) tag:self.superviewTag inFooterForSection:_section];;
}
...
- (BOOL)pridFindInScrollView { return YES; }
- (nullable UIView *)playerSuperview {
